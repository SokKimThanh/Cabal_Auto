...
class NotificationWidget(tk.Frame):
    ...
    def show(
        ...
        self.notification_frame = tk.Frame(
            self, bg=style["border"], relief="solid", bd=1
        )
        self.notification_frame.pack(fill="x", padx=2, pady=2)

        # Inner frame for content
        content_frame = tk.Frame(
            self.notification_frame, bg=style["bg"], padx=8, pady=6
        )
        ...
        if self.auto_hide_seconds > 0:
            self._auto_hide_id = self.after(self.auto_hide_seconds * 1000, self.hide)
...
if __name__ == "__main__":
    ...
    def test_notification_widget():
        ...
        notification = NotificationWidget(
            container, auto_hide_seconds=5, show_close_button=True, bg="white"
        )
        ...
        success_btn = tk.Button(
            button_frame,
            text="Show Success",
            command=lambda: notification.show_success(
        ...
        warning_btn = tk.Button(
            button_frame,
            text="Show Warning",
            command=lambda: notification.show_warning(
        ...
        error_btn = tk.Button(
            button_frame,
            text="Show Error",
            command=lambda: notification.show_error(
