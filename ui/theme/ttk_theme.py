...
def configure_ttk_styles(root=None):
    ...
    try:
            ...
            settings={
                ".": {
                    "configure": {
                        ...
                        "font": (
                            UIStyle.resolve_font_family("body"),
                            UIStyle.SIZE_TEXT,
                        ),
                ...
                "TCheckbutton": {
                    ...
                    "map": {
                        "background": [
                            ("active", UIStyle.THEME_BG_APP),
                            ("disabled", UIStyle.THEME_BG_APP),
                        ],
                        "foreground": [("disabled", UIStyle.THEME_TEXT_MUTED)],
                        "indicatorcolor": [
                            ("selected", UIStyle.THEME_STATE_HUNTING),
                            ("disabled", UIStyle.THEME_BG_APP),
                        ],
                    },
                },
                ...
                "Primary.TButton": {
                    ...
                    "map": {
                        "background": [
                            ("active", UIStyle.THEME_STATE_HUNTING_BORDER),
                            ("disabled", UIStyle.THEME_BG_PANEL),
                        ],
                        "foreground": [("disabled", UIStyle.THEME_TEXT_MUTED)],
                    },
                },
                ...
                "Neutral.TButton": {
                    ...
                    "map": {
                        "background": [
                            ("active", UIStyle.THEME_BG_SIDEBAR),
                            ("disabled", UIStyle.THEME_BG_APP),
                        ],
                        "foreground": [("disabled", UIStyle.THEME_TEXT_MUTED)],
        ...
        if "already exists" not in str(e):
            ...
            logging.getLogger(__name__).exception(
                "Failed to create ttk theme 'cabal_dark'"
            )
            return
    ...
    try:
        ...
        logging.getLogger(__name__).exception(
            "Failed to activate ttk theme 'cabal_dark'"
        )
