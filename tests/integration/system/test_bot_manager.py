...
pytestmark = [
    ...
    pytest.mark.unit,
    pytest.mark.skipif(
        sys.platform != "win32", reason="Requires Windows OS and pywin32"
    ),
]
...
class TestErrorHandling:
    ...
    def test_start_with_invalid_engine(self, mock_screen_capture):
        ...
        manager = BotManager(
            vision_engine=bad_engine, screen_capture=mock_screen_capture
        )
    ...
    def test_callback_registration_error_handling(self, manager):
        ...
        manager._detector.on_detections_changed = Mock(
