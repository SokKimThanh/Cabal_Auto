...
class TestMonsterEditorWindowClose:
    ...
    def test_close_with_no_changes_destroys_immediately(
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file):
            ...
            try:
                ...
                assert (
                    len(destroy_called) == 1
                ), "Should destroy immediately with no changes"
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file):
            ...
            try:
                ...
                with patch(
                    ...
                    assert (
                        editor.winfo_exists()
                    ), "Window should still exist after user cancels close"
    ...
    def test_close_with_changes_user_confirms_destroys(
        self, temp_data_file: Path
    ) -> None:
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file):
            ...
            try:
                ...
                with patch(
                    ...
                    assert (
                        len(destroy_called) == 1
                    ), "Should destroy after user confirms"
    ...
    def test_protocol_wm_delete_window_bound_to_cancel(
        self, temp_data_file: Path
    ) -> None:
