    ...
    def test_header_settings_button_removed(self, temp_data_file: Path) -> None:
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file):
            ...
            try:
                ...
                assert (
                    editor.settings_button is None
                ), "Header gear settings button should be removed"
            finally:
                editor.destroy()
                root.destroy()
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file):
            ...
            try:
                ...
                dialog = MonsterEditDialog(
                    editor, monster={"id": "m1", "name": "Quái Đen"}
                )
        ...
        with patch("ui.windows.monster_manager_win.DATA_PATH", temp_data_file), patch(
            ...
            try:
                ...
                with patch(
                    ...
                    assert (
                        len(saved_data) == 0
                    ), "Should not save when user rejects auto rename"
