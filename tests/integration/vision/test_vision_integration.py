...
class TestVisionEngineCapture:
    ...
    def test_start_capture_success(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
    ...
    def test_start_capture_window_not_found(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
    ...
    def test_start_capture_with_fps(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
...
class TestCaptureFrameAccess:
    ...
    def test_get_capture_frame_success(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
...
class TestWorkerIntegration:
    ...
    def test_start_worker_with_capture(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
    ...
    def test_stop_worker_stops_capture(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
...
class TestErrorHandling:
    ...
    def test_start_capture_exception_handling(self, vision_engine, mock_window_manager):
    ...
    def test_get_frame_exception_handling(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
    ...
    def test_stop_capture_exception_handling(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
...
@pytest.mark.slow
@pytest.mark.windows
@pytest.mark.skipif(not HAS_NUMPY or not HAS_CV2, reason="Requires numpy and opencv")
        ...
        if sys.platform == "win32" and WindowManager:
            ...
            if hwnd:
                ...
                result = vision_engine.start_capture(
                    window_title="Notepad", target_fps=15
                )
...
class TestPerformance:
    ...
    def test_frame_callback_overhead(
        self, vision_engine, mock_window_manager, mock_screen_capture
    ):
