...
def combo_detector():
    ...
    return CabalComboDetector(hwnd=0, poll_interval_ms=4, cooldown_guard_ms=120)
...
class TestCabalComboDetectorInitialization:
    ...
    def test_init_custom_params(self):
        ...
        detector = CabalComboDetector(
            hwnd=999, hit_zone_x_ratio=0.75, poll_interval_ms=5, cooldown_guard_ms=100
        )
...
class TestHitZoneDetection:
    ...
    def test_bright_pixel_detection(
        self, combo_detector, mock_screen_capture, bright_pixel_frame
    ):
    ...
    def test_wait_for_hit_zone_detects_bright(
        self, combo_detector, mock_screen_capture, bright_pixel_frame
    ):
...
class TestCooldownGuard:
    ...
    def test_callback_fires_once_with_cooldown(
        self, combo_detector, mock_screen_capture, bright_pixel_frame
    ):
    ...
    def test_early_exit_on_target_death(
        self, combo_detector, mock_screen_capture, bright_pixel_frame
    ):
        ...
        result = combo_detector.wait_for_hit_zone(
            mock_screen_capture, timeout_sec=1.0, is_target_alive_check=target_alive
        )
...
class TestCPUPerformance:
    ...
    def test_low_cpu_usage_during_polling(
        self, combo_detector, mock_screen_capture, dark_frame
    ):
...
class TestComboStartKeyPressedOnce:
    ...
    def test_combo_detector_single_trigger(
        self, combo_detector, mock_screen_capture, bright_pixel_frame
    ):
