...
def test_data_loading():
    ...
    test_monsters = [
        {
            ...
            "hp": 10000,
            "damage_per_hit": 175,
            "description": "Test monster 1",
        },
        {
            "name": "Dragon Boss",
            "hp": 100000,
            "damage_per_hit": 1000,
            "description": "Test monster 2",
        },
        {
            "name": "Weak Slime",
            "hp": 1000,
            "damage_per_hit": 500,
            "description": "Test monster 3",
        },
    ]
    ...
    print(
        f"✅ Total: {len(skill_names)} attack skills (filtered from {len(test_skills)} total)"
    )
    ...
    selected_monster = next(
        (m for m in test_monsters if m["name"] == selected_name), None
    )
    ...
    selected_skill = next(
        (s for s in test_skills if s["name"] == selected_skill_name), None
    )
