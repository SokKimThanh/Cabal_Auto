...
def create_demo_window():
    ...
    # Selectors frame
    selectors_frame = tk.Frame(
        main_frame, bg="#e0e0e0", relief="sunken", bd=2, padx=10, pady=10
    )
    ...
    status_text = tk.Label(
        status_frame, text="...", font=("Segoe UI", 9), bg="#f5f5f5", fg="#666"
    )
    ...
    instructions_frame = tk.Frame(
        main_frame, bg="#fff3cd", relief="solid", bd=1, padx=10, pady=10
    )
