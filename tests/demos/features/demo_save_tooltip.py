...
class TooltipDemo:
    ...
    def _update_tooltip(self):
        ...
        # Determine key
        tooltip_key = (
            "tip_apply_all_unsaved" if self.has_unsaved else "tip_apply_all_saved"
        )
    ...
    def toggle_state(self):
        ...
        if self.has_unsaved:
            self.state_label.config(
                text=(
                    "Trạng thái: ⚠️ Chưa lưu"
                    if self.lang == "vi"
                    else "State: ⚠️ Unsaved"
                ),
                bg="#FFF3E0",
                fg="#E65100",
            )
            ...
            self.state_label.config(
                text=(
                    "Trạng thái: ✅ Đã lưu" if self.lang == "vi" else "State: ✅ Saved"
                ),
                bg="#E8F5E9",
                fg="#2E7D32",
            )
