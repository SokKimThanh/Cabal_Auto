...
def test_translations():
    ...
    try:
        ...
        en_keys = [
            ...
            "user_level_new",
            "user_level_new_desc",
            "user_level_experienced",
            "user_level_experienced_desc",
            "tip_user_level_new",
            "tip_user_level_experienced",
            "open_rotation_builder",
            "tip_rotation_builder",
...
if __name__ == "__main__":
    ...
    if all_passed:
        ...
        print(
            "5. Click the rotation builder button (when enabled) to open Library Manager"
        )
    else:
