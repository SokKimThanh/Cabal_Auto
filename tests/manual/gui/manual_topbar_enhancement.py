...
class TopbarEnhancementDemo(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # Language selector
        tk.Label(topbar, text="Language:", bg="#f5f5f5", font=("Arial", 9)).pack(
            side="left", padx=(0, 4)
        )
        lang_combo = ttk.Combobox(
            topbar, state="readonly", width=10, values=["en", "vi"]
        )
        lang_combo.current(1)  # Vietnamese
        lang_combo.pack(side="left", padx=(0, 12))

        # Separator
        tk.Frame(topbar, width=2, bg="#ccc", relief="sunken").pack(
            side="left", fill="y", padx=8
        )

        # Window selection combobox (NEW!)
        tk.Label(
            topbar, text="🪟 Game Window:", bg="#f5f5f5", font=("Arial", 9, "bold")
        ...
        tk.Label(
            content,
            text="✨ Topbar Enhancement Features",
            font=("Arial", 14, "bold"),
            fg="#333",
        ).pack(anchor="w", pady=(0, 10))

        # Feature 1
        feature1 = tk.LabelFrame(
            content,
            text="1️⃣ Window Selection in Topbar",
            font=("Arial", 11, "bold"),
            padx=15,
            pady=10,
        )
        ...
        tk.Label(
            feature1,
            text="• Window list changed from Listbox → Combobox\n"
        ...
        # Feature 2
        feature2 = tk.LabelFrame(
            content,
            text="2️⃣ Auto PID Detection",
            font=("Arial", 11, "bold"),
            padx=15,
            pady=10,
        )
        ...
        tk.Label(
            feature2,
            text="• Triggered when new user cancels Setup Wizard\n"
        ...
        tk.Button(
            btn_frame,
            text="🎬 Demo Auto Detection",
            command=self._demo_auto_detection,
            bg="#4CAF50",
            fg="white",
            padx=10,
            pady=4,
        ...
        # Feature 3
        feature3 = tk.LabelFrame(
            content,
            text="3️⃣ Auto Bring-to-Front",
            font=("Arial", 11, "bold"),
            padx=15,
            pady=10,
        )
        ...
        tk.Label(
            feature3,
            text="• Window auto brought to front when selected from combobox\n"
        ...
        # Feature 4
        feature4 = tk.LabelFrame(
            content,
            text="4️⃣ Hunt Controls in Topbar",
            font=("Arial", 11, "bold"),
            padx=15,
            pady=10,
        )
        ...
        tk.Label(
            feature4,
            text="• Start/Stop buttons moved to topbar\n"
        ...
        self.status_var = tk.StringVar(
            value="Ready - Click 'Find Windows' to see window list"
        )
        status_bar = tk.Label(
            self,
        ...
        log_frame = tk.LabelFrame(
            content, text="📋 Demo Log", font=("Arial", 10, "bold"), padx=10, pady=8
        )
    ...
    def _find_windows(self):
        ...
        self.status_var.set(
            f"✓ Found {len(self.windows)} windows - Select from combobox to bring to front"
        )
    ...
    def _simulate_bring_to_front(self):
        ...
        self.status_var.set(
            f"✓ Window active: {self.selected_window['title']} [PID:{self.selected_window['pid']}]"
        )
    ...
    def _complete_startup(self, window):
        ...
        self.after(
            ...
            lambda: self.status_var.set(
                "Ready - Click 'Find Windows' to see window list"
            ),
        )
    ...
    def _complete_auto_detection(self):
        ...
        self.status_var.set(
            f"✓ Auto-detected: {detected['title']} [PID:{detected['pid']}]"
        )
    ...
    def _start_hunt(self):
        ...
        self.stop_btn.config(
            state="normal", bg="#C62828", fg="white", relief="raised", cursor="hand2"
        )
    ...
    def _stop_hunt(self):
        ...
        self.start_btn.config(
            state="normal", bg="#2E7D32", relief="raised", cursor="hand2"
        )
        self.stop_btn.config(
            state="disabled", bg="#FFCDD2", fg="#999", relief="sunken", cursor="arrow"
        )
...
def show_comparison():
    ...
    header = tk.Label(
        root,
        text="📊 UI Layout Comparison - Topbar Enhancement",
        font=("Arial", 14, "bold"),
        bg="#343a40",
        fg="white",
        pady=12,
    ...
    footer = tk.Label(
        root,
        text="💡 Key Benefits: Faster workflow • Less clicks • Cleaner UI • Better new user experience • Auto window management",
        bg="#e7f3ff",
        fg="#004085",
        font=("Arial", 9),
        pady=10,
...
def show_menu():
    ...
    header = tk.Label(
        root,
        text="🎨 Topbar Enhancement - Test Suite",
        font=("Arial", 16, "bold"),
        bg="#343a40",
        fg="white",
        pady=15,
    ...
    desc = tk.Label(
        root,
        text="Window Selection & Hunt Controls Enhancement\n\n"
        "✨ Features:\n"
        "• Window selection combobox in topbar\n"
    ...
    tk.Button(
        buttons_frame,
        text="2️⃣ Before & After Comparison\n\n"
