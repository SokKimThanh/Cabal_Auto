...
GLOBAL_TRANSLATIONS = {
    ...
    'en': {
        ...
        'tab_stats': 'Stats',
        'monster_rotation.title': 'Monster Rotation',
        'monster_rotation.mode_sequence': 'Sequence',
        'monster_rotation.mode_priority': 'Priority',
        'monster_rotation.add_btn': 'Add Monster',
        'monster_rotation.remove_btn': 'Remove',
        'monster_rotation.unknown_badge': 'Unknown',
        'tab_help': 'Help',
...
• You can customize hotkeys in Setup → Global Hotkeys section''',
    ...
    'vi': {
        ...
        'tab_stats': 'Thống kê',
        'monster_rotation.title': 'Quái Mục Tiêu',
        'monster_rotation.mode_sequence': 'Tuần tự',
        'monster_rotation.mode_priority': 'Khoảng cách',
        'monster_rotation.add_btn': 'Thêm Quái',
        'monster_rotation.remove_btn': 'Xóa',
        'monster_rotation.unknown_badge': 'Chưa rõ',
        'tab_help': 'Trợ giúp',
