...
GLOBAL_TRANSLATIONS = {
    'en': {
        ...
        'msg_class_scan_mismatch': 'Scanned class differs from selected class. Update?',
        ...
        'msg_unsaved_class_change': 'You have unsaved changes. Change class anyway?',
        ...
        'btn_language_manager': 'Language Manager',
        'lang_mgr_namespace': 'Namespace:',
        'lang_mgr_search': 'Search:',
        'lang_mgr_refresh': 'Refresh',
        'lang_mgr_sync': 'Sync to JSON',
        'lang_mgr_col_ns': 'Namespace',
        'lang_mgr_col_key': 'Key',
        'lang_mgr_col_en': 'Text (EN)',
        'lang_mgr_col_vi': 'Text (VI)',
        'lang_mgr_col_updated': 'Updated At',
        'lang_mgr_edit_form': 'Add / Edit Translation',
        'tip_lang_mgr_namespace': 'Namespace separates keys by screen to prevent collisions (e.g. _global for common keys).',
        'lang_mgr_key': 'Key:',
        ...
        'scan_history_empty_message': 'No scan data available.',
        'scan_history_empty_submessage': 'Perform a region scan on the screen to save data.',
        ...
        'btn_delete': 'Delete',
        'btn_refresh': 'Refresh',
        'tooltip_icon_manager_refresh': 'Reload list from database (does not alter data)',
        'tooltip_icon_manager_sync': 'Scan and update icons from system to database. Takes time.',
        'btn_syncing': 'Syncing...',
        'btn_sync_cooldown': 'Synced ({s}s)',
        'msg_sync_success_none': 'Data is already up to date.',
        'btn_save': 'Save',
        'btn_cancel': 'Cancel',
        'btn_prev': 'Prev',
        'btn_next': 'Next',
    ...
    'vi': {
        ...
        'btn_delete': 'Xóa',
        'btn_refresh': 'Làm mới',
        'tooltip_icon_manager_refresh': 'Tải lại danh sách từ cơ sở dữ liệu (không thay đổi dữ liệu gốc)',
        'tooltip_icon_manager_sync': 'Quét và cập nhật icon mới từ hệ thống vào DB. Có thể mất chút thời gian.',
        'btn_syncing': 'Đang đồng bộ...',
        'btn_sync_cooldown': 'Đã đồng bộ ({s}s)',
        'msg_sync_success_none': 'Dữ liệu đã ở trạng thái mới nhất.',
        'btn_save': 'Lưu',
        'btn_cancel': 'Hủy',
        'btn_prev': 'Trước',
        'btn_next': 'Sau',
        ...
        'btn_confirm': 'Xác nhận',
                                                                'btn_generate_id': 'Btn Generate Id',
        'btn_build_manager': 'Quản lý Build',
        'btn_class_manager': 'Quản lý Lớp',
        'btn_icon_manager': 'Quản lý Icon',
        ...
        'all_locations': 'Tất cả môi trường',
        'all_monsters': 'Tất cả quái vật',
        'col_dungeon': 'Môi trường sống',
        'col_hp': 'Máu',
        'col_id': 'ID',
        'col_image': 'Hình',
        'col_level': 'Cấp',
        ...
        'logs_level': 'Cấp độ:',
        'logs_search': 'Tìm kiếm',
        'logs_copy': 'Sao chép',
        'logs_folder': 'Mở thư mục',
        ...
        'monster_dungeon_label': 'Môi trường sống:',
        ...
        'msg_class_scan_mismatch': 'Lớp nhân vật quét được khác với lựa chọn. Cập nhật?',
        ...
        'msg_unsaved_class_change': 'Bạn có thay đổi chưa lưu. Vẫn tiếp tục đổi lớp nhân vật?',
        ...
        'btn_language_manager': 'Quản lý Ngôn ngữ',
        'lang_mgr_namespace': 'Namespace:',
        'lang_mgr_search': 'Tìm kiếm:',
        'lang_mgr_refresh': 'Làm mới',
        'lang_mgr_sync': 'Đồng bộ JSON',
        'lang_mgr_col_ns': 'Namespace',
        'lang_mgr_col_key': 'Từ khóa (Key)',
        'lang_mgr_col_en': 'Văn bản (EN)',
        'lang_mgr_col_vi': 'Văn bản (VI)',
        'lang_mgr_col_updated': 'Ngày cập nhật',
        'lang_mgr_edit_form': 'Thêm / Sửa Bản dịch',
        'tip_lang_mgr_namespace': 'Namespace (Không gian tên) dùng để phân nhóm từ khoá theo từng màn hình (ví dụ: _global cho từ khoá dùng chung), giúp tránh trùng lặp nội dung.',
        'lang_mgr_key': 'Từ khóa:',
        ...
        'scan_history_empty_message': 'Chưa có dữ liệu scan nào.',
        'scan_history_empty_submessage': 'Hãy thực hiện quét vùng trên màn hình để lưu dữ liệu.',
