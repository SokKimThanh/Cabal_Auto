    ...
    def start_detection(
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error(
                    f"[BotManager] Error starting detection: {e}", exc_info=True
                )
                return False
    ...
    def stop_detection(self) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error(
                    f"[BotManager] Error stopping detection: {e}", exc_info=True
                )
                return False
    ...
    def pause_detection(self) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error(
                    f"[BotManager] Error pausing detection: {e}", exc_info=True
                )
                return False
    ...
    def resume_detection(self) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.error(
                    f"[BotManager] Error resuming detection: {e}", exc_info=True
                )
                return False
