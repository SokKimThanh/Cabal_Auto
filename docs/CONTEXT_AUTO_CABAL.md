...
This document summarizes the current project context from “assets/documents/Ngữ cảnh tạo auto cabal.txt” so developers have a concise, actionable reference linked to code modules and data schemas.
...
## 🔗 Cross‑References
- Source context: assets/documents/Ngữ cảnh tạo auto cabal.txt (2025‑10‑18).
