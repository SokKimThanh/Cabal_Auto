...
## ARCHIVE
* `patch_app_gui_metadata.py` -> `docs/archive/scripts/` (One-off script)
* `patch_app_gui_reorder.py` -> `docs/archive/scripts/` (One-off script)
* `patch_auto_bring.diff` -> `docs/archive/scripts/` (Patch file)
* `patch_concurrency_test.py` -> `docs/archive/scripts/` (One-off test)
* `patch_concurrency_test2.py` -> `docs/archive/scripts/` (One-off test)
* `patch_first_time.diff` -> `docs/archive/scripts/` (Patch file)
* `patch_geometry.diff` -> `docs/archive/scripts/` (Patch file)
* `patch_hunt_config_mutation.py` -> `docs/archive/scripts/` (One-off script)
* `patch_hunt_tab_fix.py` -> `docs/archive/scripts/` (One-off script)
* `patch_hunt_tab_fix_2.py` -> `docs/archive/scripts/` (One-off script)
* `patch_hunt_tab_fix_3.py` -> `docs/archive/scripts/` (One-off script)
* `patch_hunt_tab_fix_4.py` -> `docs/archive/scripts/` (One-off script)
* `patch_main.diff` -> `docs/archive/scripts/` (Patch file)
* `patch_migrator4.py` -> `docs/archive/scripts/` (One-off script)
* `patch_monster_picker_headings.py` -> `docs/archive/scripts/` (One-off script)
* `patch_monster_picker_int.py` -> `docs/archive/scripts/` (One-off script)
* `patch_monster_picker_map.py` -> `docs/archive/scripts/` (One-off script)
* `patch_monster_picker_minsize.py` -> `docs/archive/scripts/` (One-off script)
* `patch_rename_rotation.py` -> `docs/archive/scripts/` (One-off script)
* `patch_rename_rotation2.py` -> `docs/archive/scripts/` (One-off script)
* `patch_test_fix.py` -> `docs/archive/scripts/` (One-off script)
* `patch_test_priority.py` -> `docs/archive/scripts/` (One-off script)
* `patch_test_queue.py` -> `docs/archive/scripts/` (One-off script)
* `patch_tests.py` -> `docs/archive/scripts/` (One-off script)
* `patch_tests_2.py` -> `docs/archive/scripts/` (One-off script)
* `patch_tests_picker.py` -> `docs/archive/scripts/` (One-off script)
